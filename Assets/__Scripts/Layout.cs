...
public class Layout : MonoBehaviour {
	...
	public Vector2 multiplier; //Sets the spacing of the tableu
	//SlotDef references
	...
	public void ReadLayout(string xmlText) {
		...
		//Various attributes are parsed into numerical values
			...
			//The layers are used to make sure that the correect cards are
			//on top of the others. In Unity@D, all of our assets are
